...
public class XQueryExecutor {
     ...
     * @return a {@link List<XMLElement>} containing the result XML elements found as a result of executing the query
     ...
     * @return a {@link List<XMLElement>} containing the result XML elements found as a result of executing the query
     */
    public static List<XMLElement> executeFromString(String query) {
