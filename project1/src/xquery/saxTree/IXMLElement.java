 ...
 *
 * {@link project1.xquery.xmltree.XMLElement} is an implementation of this interface. It wraps the
...
public interface IXMLElement {
     ...
     * @return a compact String representation of this eleme
     */
    String toCompactString();

    /**
     * Converts this element to a pretty-printed string, including all attributes, text, and sub-elements.
     * @return a pretty-printed String representation of this element
     */
    String toString();
}
